						...
						<div class="row">
							<div class="col-lg-5" style="margin-left: 50px;">
								...
								<div class="form-group">
									...
									<div class="col-lg-8">
										<input type="text" id="branchState" name="branchState" class="form-control" placeholder="Branch State" />
									</div>
								</div>
								<div class="form-group">
									<label for="" class="control-label col-lg-4">Branch-Pincode</label>
									<div class="col-lg-8">
										<input type="text" id="branchPincode" name="branchPincode" class="form-control" placeholder="Branch PinCode" />
									</div>
								</div>
							</div>
							<div class="col-lg-5">
								...
								<div class="form-group">
									...
									<div class="col-lg-8">
										<input type="text" id="branchStreetAddress" name="branchStreetAddress" class="form-control" placeholder="Branch Street Address" />
									</div>
								</div>
								<div class="form-group">
									<label for="" class="control-label col-lg-4">Branch-City</label>
									<div class="col-lg-8">
										<input type="text" id="branchCity" name="branchCity" class="form-control" placeholder="Branch City" />
									</div>
								</div>
							</div>
						</div>

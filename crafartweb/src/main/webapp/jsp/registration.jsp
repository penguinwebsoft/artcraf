...
<body style="width: 100%;">
	...
	<div class="row">
		<div class="row">
			<div class="col-lg-5" style="margin-left: 50px;">
				<form class="form-horizontal" action="#" id="CustomerRegistrationId">
					<div class="col-sm-5">
						...
						<div class="form-group">
							<label for="" class="control-label">Phone-No</label> <input type="text" id="phoneNo" name="phoneNo" class="form-control" placeholder="Phone No" />
						</div>
					</div>
					<div class="col-sm-5 col-sm-offset-2">
						...
						<div class="form-group">
							<label for="" class="control-label">States</label> <input type="text" id="states" name="states" class="form-control" placeholder="States" />
						</div>
				...
				<br>
				<div class="row">
					<span class="col-sm-4 col-sm-offset-1"> <a class="btn btn-success" id="">Create Account</a>&nbsp;&nbsp;&nbsp;
					</span>
				</div>
			</div>
			<div class="col-lg-5 col-sm-offset-1">
				...
				<div class="row">
					<div class="col-sm-6" style="margin-bottom: 15px;">
						<a class="btn btn-block btn-social btn-google-plus"> <i class="icon-google-plus"></i> Sign in with Google
						</a>
					</div>
				</div>
				...
				<div class="row">
					<div class="col-sm-6">
						<a class="btn btn-block btn-social btn-facebook"> <i class="icon-facebook"></i> Sign in with Facebook
						</a>
					</div>
				</div>
			<div class="row">
			...
			<div class="row">
				<span class="col-sm-4 col-sm-offset-1"> <a class="btn btn-success btn-flat" href="#">&nbsp;&nbsp;Login&nbsp;&nbsp;</a>
				</span>
			</div>
		</div>
	</div>

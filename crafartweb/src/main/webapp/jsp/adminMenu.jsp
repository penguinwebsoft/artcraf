...
<div class="media user-media well-small" style="margin-top: 1px;">
	...
	<div class="media-body">
		<h5 class="media-heading">Amlan Gosh</h5>
	</div>
	<br />
</div>
<ul id="menu" class="collapse" id="sampleTabs" style="background-color: #333;">
	<li class="panel"><a id="dashboardMenuId" href="#"> <i class="icon-table"></i> Customer Information
	</a></li>
	<li class="panel"><a id="dashboardMenuId" href="#"> <i class="icon-table"></i> Seller Information
	</a></li>

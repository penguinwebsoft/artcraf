...
<div class="col-lg-10">
	<div class="container-fluid" style="background-color: white;">
		<div class="row">
			<div class="col-lg-3">
				<h1 style="color: #333; font-size: 25px; margin-top: 20px;">&nbsp; Add Coupon Page</h1>
			</div>
		...
		<div class="panel panel-default">
			<div class="panel-heading">
				<h3 class="panel-title">
					<i class="icon-th-list"></i> &nbsp; Add Coupon Page
				</h3>
			</div>
							...
							<div class="tab-content">
								...
								<div class="tab-pane fade in active" id="tab-general">
									...
									<div class="form-group">
										...
										<div class="col-sm-10">
											<select name="discounttype" id="input-discounttype" placeholder="---please select---" class="form-control">

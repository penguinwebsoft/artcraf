...
<div class="col-lg-10">
	<div class="container-fluid" style="background-color: white;">
		<div class="row">
			<div class="col-lg-3">
				<h1 style="color: #333; font-size: 25px; margin-top: 20px;">&nbsp;Edit Attribute Page</h1>
			</div>
		...
		<div class="panel panel-default">
			<div class="panel-heading">
				<h3 class="panel-title">
					<i class="icon-th-list"></i> &nbsp;Edit Attribute List
				</h3>
			</div>
					...
					<div class="col-lg-12">
						<form id="form-product" class="form-horizontal" enctype="multipart/form-data" method="post" action="#">
							...
							<div class="form-group">
								...
								<div class="col-sm-10">
									<input type="text" name="attributename" value="" placeholder="attributename" id="input-attributename" class="form-control" />
								</div>
							</div>
							<div class="form-group">

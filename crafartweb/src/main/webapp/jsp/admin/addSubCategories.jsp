...
<div class="col-lg-10">
	<div class="container-fluid" style="background-color: white;">
		<div class="row">
			<div class="col-lg-3">
				<h1 style="color: #333; font-size: 25px; margin-top: 20px;">&nbsp; Add Sub Categories</h1>
			</div>
							...
							<div class="tab-content">
								...
								<div class="tab-pane fade in active" id="tab-general">
									<div class="form-group">
										<label class="col-sm-2 control-label" for="input-name">Categories Name</label>
										<div class="col-sm-10">
									...
									<div class="form-group required">
										...
										<div class="col-sm-10">
											<input type="text" name="subcatgegories" value="" placeholder="subcategories" id="input-subcategories" class="form-control" />
										</div>
									</div>
									<div class="form-group">

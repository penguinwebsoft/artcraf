...
<form:form id="updateCategory" name="updateCategoryForm" cssClass="form-horizontal" commandName="category">
								...
								<div class="tab-content">
									...
									<div class="tab-pane fade in active" id="tab-general">
										<div class="form-group required">
											...
											<div class="col-sm-10">
												<form:input type="text" path="categoryName" value="" placeholder="name" id="categoryName" class="form-control" />
											</div>
										</div>
										...
										<div class="form-group">
											...
											<div class="col-sm-10">
												<form:textarea path="seoBO.metaDesc" rows="5" placeholder="metatagdescription" id="metaDescription" class="form-control"></form:textarea>
											</div>
										</div>
										<div class="form-group">

...
<nav class="navbar navbar-inverse navbar-fixed-top " style=" font-size: 16px;">
	...
	<header class="navbar-header">
		<a href="${baseURL}/menu/dashboard" class="navbar-brand"> <img src="${context}/resources/img/logo.png" alt="" />
		</a>
	</header>
	<!-- END LOGO SECTION -->

	<ul class="nav navbar-top-links navbar-right">
		<li class="dropdown"><a class="dropdown-toggle" data-toggle="dropdown" href="#"> <span class="label label-success">2</span> <i class="icon-tasks"></i>&nbsp; <i class="icon-chevron-down"></i>
          <i class="icon-bell icon-white"></i></a>
			<ul class="dropdown-menu dropdown-messages">
				...
				<li><a href="#">
						...
						<div>
							Lorem ipsum dolor sit amet, consectetur adipiscing. <br /> <span class="label label-success"> Moderate </span>
						</div>
				</a></li>
				<li class="divider"></li>
				<li><a href="#">
		...
		<li><a href="#"> <i class="icon-user"> </i> User Profile
		</a></li>
		<li><a href="#"> <i class="icon-gear"> </i> Change Password
		</a></li>
		<li><a href="#"> <i class="icon-signout"> </i> Logout
		</a></li>
	</ul>
</nav>

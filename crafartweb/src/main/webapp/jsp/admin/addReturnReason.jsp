...
<div class="col-lg-10">
	<div class="container-fluid" style="background-color: white;">
		<div class="row">
			<div class="col-lg-3">
				<h1 style="color: #333; font-size: 25px; margin-top: 20px;">&nbsp;Add Return Reason Template</h1>
			</div>
		...
		<div class="panel panel-default">
			<div class="panel-heading">
				<h3 class="panel-title">
					<i class="icon-th-list"></i> &nbsp;Add Return Reason Template
				</h3>
			</div>
					...
					<div class="col-lg-12">
						<form id="form-product" class="form-horizontal" enctype="multipart/form-data" method="post" action="#">
							...
							<div class="form-group">
								<label class="col-sm-2 control-label" style="padding-top: 1px;" for="rrm"><span data-toggle="tooltip" title="rrm">Return Reason Name</span></label>
								<div class="col-sm-10">
									<input type="text" name="rrm" value="" placeholder="orderstatus" id="rrm" class="form-control" />
								</div>
							</div>
							<div class="form-group">

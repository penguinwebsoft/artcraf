...
<!-- BODY CONTENT -->
	<div class="container-fluid" style="padding-right: 15px; padding-left: 15px; margin-right: auto; margin-left: auto;background-image: url(${context}/resources/img/background_img.jpg);"">
		...
		<div style="background-color: #FBF5F5; margin-left: 5%; margin-right: 5%">
			...
			<!-- right side content -->
			<div class="col-md-8">
				<h3 style="margin-left: 10%">CRAFART WEBSITE DEVELOPMENT</h3>
				<div class="col-md-6">
				...
				<div style="margin-top: 10%; margin-left: 2%">
					<span class=" icon-share" style="font-size: 130%">Viewing Compability Accessories</span>
					<div>
						<hr>
						<span class="icon-map-marker" style="font-size: 130%; margin-bottom: 50%">Check Availability at</span> <input type="text" placeholder="Enter a pincode" />
			...
			<div style="margin-left: 4%; margin-right: 4%;">
				<div>
					<nav class="navbar breadcrumb_cus" role="navigation">

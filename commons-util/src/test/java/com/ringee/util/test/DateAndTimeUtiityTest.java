...
import com.crafart.util.DateAndTimeUtility;
import com.crafart.util.DateAndTimeUtility.DATEFORMAT;
import com.crafart.util.DateAndTimeUtility.TimeZoneConstant;
...
public class DateAndTimeUtiityTest {
	...
	public void testConvertStringToDate() {
		...
		try {
			parsedDate = DateAndTimeUtility.changeDateFormat("2014-10-04 00:00:00", DATEFORMAT.DB_FORMAT_YYYY_DD_MM, DATEFORMAT.DD_MMM_YY);
	...
	public void testConvertDateFormat() {
		try {
			String parsedDate = DateAndTimeUtility.changeDateFormat("24.04.2014", DATEFORMAT.CLIENT_FORMAT_MM_DD_YYYY, DATEFORMAT.DB_FORMAT_YYYY_DD_MM);
	...
	public void testUpdatedEventDateLessThanPreviousEventDate() {
		try {
			...
			String fromEventDateStr = DateAndTimeUtility.changeDateFormat(fromDate, DATEFORMAT.CLIENT_FORMAT_MM_DD_YYYY, DATEFORMAT.SYSTEM_DATE_FORMAT);
			...
			String toEventDateStr = DateAndTimeUtility.changeDateFormat(toDate, DATEFORMAT.CLIENT_FORMAT_MM_DD_YYYY, DATEFORMAT.SYSTEM_DATE_FORMAT);
